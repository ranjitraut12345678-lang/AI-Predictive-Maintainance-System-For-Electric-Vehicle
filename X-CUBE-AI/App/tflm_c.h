 ...
 * - v4.0: align code with ~Tensorflow 2.17
 *         c.api changes - 2.2 remove unused fields from "tflm_c_tensor_info"
 */
...
#define TFLM_C_VERSION_MINOR  (2)
#define TFLM_C_VERSION_STR    "2.2"
